...
class ResidualDenseBlock(nn.Module):
    ...
    def __init__(self, num_feat=64, num_grow_ch=32):
        ...
        self.conv1 = SeparableConv2d(num_feat, num_grow_ch, 3, 1, 1)
        self.conv2 = SeparableConv2d(num_feat + num_grow_ch, num_grow_ch, 3, 1, 1)
        self.conv3 = SeparableConv2d(num_feat + 2 * num_grow_ch, num_grow_ch, 3, 1, 1)
...
class SeparableRRDBNet(nn.Module):
    ...
    def __init__(self, num_in_ch, num_out_ch, scale=4, num_feat=64, num_block=23, num_grow_ch=32):
        ...
        self.conv_body = SeparableConv2d(num_feat, num_feat, 3, 1, 1)
        # upsample
        self.conv_up1 = SeparableConv2d(num_feat, num_feat, 3, 1, 1)
        self.conv_up2 = SeparableConv2d(num_feat, num_feat, 3, 1, 1)
